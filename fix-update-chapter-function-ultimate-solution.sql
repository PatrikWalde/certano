-- 🔒 update_chapter_with_questions Function ULTIMATIVE LÖSUNG
-- Behebt die hartnäckige "role mutable search_path" Warnung
-- Verwendet einen komplett anderen Ansatz: Function ohne search_path Parameter
...
-- 3. Überprüfung
SELECT 'update_chapter_with_questions Function ULTIMATIVE LÖSUNG abgeschlossen' as status;
