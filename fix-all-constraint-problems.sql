-- 🔧 ALLE Constraint Probleme beheben
-- Problem: difficulty 'advanced' und andere Werte verletzen Constraints
-- Lösung: Korrigiere alle problematischen Werte
...
SELECT 'ALLE Constraint Probleme beheben abgeschlossen' as status;
