-- 🔒 update_chapter_with_questions Function KOMPLETT NEU ERSTELLEN
-- Behebt die hartnäckige "role mutable search_path" Warnung
-- Löscht ALLES und erstellt die Function komplett neu

-- 1. ALLE Versionen der Function löschen (auch mit verschiedenen Parametern)
...
-- 2. Function komplett neu erstellen mit korrektem search_path
...
-- 3. Überprüfung
SELECT 'update_chapter_with_questions Function KOMPLETT NEU ERSTELLT' as status;
